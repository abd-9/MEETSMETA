              ...
              <Row className='align-items-center'>
                <Col lg={6} className='order-2 order-lg-1'>
                  <TabContent
                    ...
                    <TabPane
                      tabId='v-pills-work'
                      className='fade show'></TabPane>
                    <TabPane
                      tabId='v-pills-marketing'
                      className='fade show'></TabPane>
                    <TabPane
                      tabId='v-pills-feedback'
                      className='fade show'></TabPane>
                  </TabContent>
                </Col>
                  ...
                  <Nav
                    ...
                    <NavItem>
                      <NavLink
                        ...
                        className={classnames(
                          { active: this.state.activeTab === "v-pills-work" },
                          "rounded",
                        )}
                        onClick={() => {
                        ...
                        id='v-pills-work-tab'>
                        <h4 className='text-dark f-18'>
                          Works With Existing Apps
                        </h4>
                        <p className='text-muted f-15'>
                          At solmen necessi a uniform grammatica pronunciation
                    ...
                    <NavItem>
                      <NavLink
                        ...
                        className={classnames(
                          {
                            active:
                              this.state.activeTab === "v-pills-marketing",
                          },
                          "rounded",
                        )}
                        onClick={() => {
                    ...
                    <NavItem>
                      <NavLink
                        ...
                        className={classnames(
                          {
                            active: this.state.activeTab === "v-pills-feedback",
                          },
                          "rounded",
                        )}
                        onClick={() => {
                        ...
                        id='v-pills-work-tab'>
                        <h4 className='text-dark f-18'>
                          Get Private Customers Feedback
                        </h4>
                        <p className='text-muted f-15'>
                          At solmen necessi a uniform grammatica pronunciation
                          sommun plu paroles ma quande.
